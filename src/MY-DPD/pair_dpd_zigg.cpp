...
PairDPDZigg::PairDPDZigg(LAMMPS *lmp) : Pair(lmp)
{
  writedata = 1;
  random = NULL;
}
...
void PairDPDZigg::compute(int eflag, int vflag)
{
...
void PairDPDZigg::settings(int narg, char **arg)
{
...
void PairDPDZigg::coeff(int narg, char **arg)
{
  if (narg < 4 || narg > 5)
...
double PairDPDZigg::init_one(int i, int j)
{
...
void PairDPDZigg::write_restart(FILE *fp)
{
...
void PairDPDZigg::read_restart(FILE *fp)
{
...
void PairDPDZigg::write_restart_settings(FILE *fp)
{
...
void PairDPDZigg::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
void PairDPDZigg::write_data(FILE *fp)
{
...
void PairDPDZigg::write_data_all(FILE *fp)
{
  for (int i = 1; i <= atom->ntypes; i++)
...
double PairDPDZigg::single(int /*i*/, int /*j*/, int itype, int jtype, double rsq,
