...
PairDPDZiggTstat::PairDPDZiggTstat(LAMMPS *lmp) : PairDPDZigg(lmp)
{
  single_enable = 0;
  writedata = 1;
}
...
void PairDPDZiggTstat::compute(int eflag, int vflag)
{
...
void PairDPDZiggTstat::settings(int narg, char **arg)
{
...
void PairDPDZiggTstat::coeff(int narg, char **arg)
{
  if (narg < 3 || narg > 4)
...
void PairDPDZiggTstat::write_restart(FILE *fp)
{
...
void PairDPDZiggTstat::read_restart(FILE *fp)
{
...
void PairDPDZiggTstat::write_restart_settings(FILE *fp)
{
...
void PairDPDZiggTstat::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
void PairDPDZiggTstat::write_data(FILE *fp)
{
...
void PairDPDZiggTstat::write_data_all(FILE *fp)
{
  for (int i = 1; i <= atom->ntypes; i++)
